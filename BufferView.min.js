...
*/
module.exports=function(){var b=function(a,c,b,e){c=c||0;b=b||a.length;this.buffer=0===c&&b===a.length?a:a.slice(c||0,b||a.length);this.noAssert=!!e};b.create=function(a,c,d){return"function"===typeof Buffer&&"function"===typeof Buffer.isBuffer&&Buffer.isBuffer(a)?new b(a,c,d):new DataView(a,c,d)};b.isBufferView=function(a){return a&&a instanceof b};b.isDataView=function(a){return a&&a instanceof DataView&&!(a instanceof b)};b.prototype=Object.create(DataView.prototype);(function(){for(var a in b.prototype)delete b.prototype[a]})();
b.prototype.getUint8=function(a){return this.buffer.readUInt8(a,this.noAssert)};b.prototype.setUint8=function(a,c){if(!this.noAssert&&(0>a||a>=this.buffer.length))throw Error("Offset out of bounds: "+a);this.buffer.writeUInt8(c,a,!0)};b.prototype.getInt8=function(a){return this.buffer.readInt8(a,this.noAssert)};b.prototype.setInt8=function(a,c){if(!this.noAssert&&(0>a||a>=this.buffer.length))throw Error("Offset out of bounds: "+a);this.buffer.writeInt8(c,a,!0)};b.prototype.getUint16=function(a,c){return c?
this.buffer.readUInt16LE(a,this.noAssert):this.buffer.readUInt16BE(a,this.noAssert)};b.prototype.setUint16=function(a,c,b){if(!this.noAssert&&(0>a||a+2>this.buffer.length))throw Error("Offset out of bounds: "+a);b?this.buffer.writeUInt16LE(c,a,!0):this.buffer.writeUInt16BE(c,a,!0)};b.prototype.getInt16=function(a,c){return c?this.buffer.readInt16LE(a,this.noAssert):this.buffer.readInt16BE(a,this.noAssert)};b.prototype.setInt16=function(a,c,b){if(!this.noAssert&&(0>a||a+2>this.buffer.length))throw Error("Offset out of bounds: "+
